...
public class FillDatabaseJson {
    ...
    private int num_grps = 0; //contador, no editar
    private int num_evts = 0; //contador, no editar
    //maxims
    ...
    //llistes
    private ArrayList<Usuario> cms = new ArrayList<Usuario>(num_cms);
    private ArrayList<Usuario> usuarios = new ArrayList<Usuario>(num_users);
    private ArrayList<Tag> tags = new ArrayList<Tag>(num_tags);
    private ArrayList<Grupo> grupos = new ArrayList<Grupo>();
    private ArrayList<Evento> eventos = new ArrayList<Evento>();
    //llistes strings
    private Nicknames nicksList = new Nicknames();
    private Groupnames groupsList = new Groupnames();
    private TagNames tagsList = new TagNames();
    private Eventnames evtsList = new Eventnames();
    private ArrayList<String> nicknames = nicksList.getNicknames();
    private ArrayList<String> groupnames = groupsList.getGroupNames();
    private ArrayList<String> tagnames = tagsList.getTagNames();
    private ArrayList<String> eventnames = evtsList.getEventnames();

    private void generacio_joc_proves() {
        //creem num_tags tags
    ...
    private String getSufix(int i, int size) {
        String suf = "";
        if (i >= size) {
            int div = i/size + 1;
            suf = "" + div;
